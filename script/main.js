...
countDiv.innerHTML = `
          ...
          <div>
          <img class="w-[50px]" src="assets/aperture.png" alt="">
          </div>
          <div class="text-2xl font-semibold">
          <span><strong>${filtered.length}</strong> Issues</span>
          </div></div>
          <span class="text-sm text-center text-gray-500">
          Track and manage your project issues</span>
          <div class="text-sm">
          <a class="mr-4 text-green-500">Open</a>
          <a class="text-red-500">closed</a></div></div>`;
